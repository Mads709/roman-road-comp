...
var map = new ol.Map({
    ...
    view: new ol.View({
         maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:27700',
            extent: [92631.695927, -20483.173911, 675741.966878, 803352.702221],
            units: 'm'})
    })
});
...
layerSwitcher.showPanel();
    ...
    var searchLayer = new SearchLayer({
      layer: lyr_reprojectedengroadpoints_11,
      colName: 'name',
      zoom: 10,
      collapsed: true,
      map: map
...
map.getView().fit([-65619.590198, 55073.581668, 941879.564879, 688671.652796], map.getSize());
